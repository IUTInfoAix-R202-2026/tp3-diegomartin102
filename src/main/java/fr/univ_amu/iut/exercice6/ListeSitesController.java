...
public class ListeSitesController {
  ...
  public int ajouterSiteDemo() {
    ...
    compteurDemo += 1;
    SiteCarte siteC = new SiteCarte();
    siteC.setNumeroCarre("Carré " + (640000 + compteurDemo));
    siteC.setNomConvivial("📍 Site de démonstration #" + compteurDemo);
    siteC.setNombrePoints((compteurDemo % 3) + 1);
    siteC.setNombrePassages(compteurDemo * 2);
    siteC.setJoursDepuisDernierPassage(compteurDemo * 4);
    conteneurCartes.getChildren().add(0, siteC);
